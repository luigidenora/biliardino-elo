...
- generic [ref=e1]:
  ...
  - generic [ref=e11]:
    ...
    - generic [ref=e49]:
      ...
      - button "🔔 Mostra Banner" [ref=e51] [cursor=pointer]
  ...
  - generic [ref=e57]:
    - generic [ref=e58]:
      - heading "🎮 Seleziona il tuo giocatore" [level=2] [ref=e59]
      - paragraph [ref=e60]: Scegli il tuo nome per ricevere le notifiche delle partite
    - generic [ref=e61]:
      - textbox "Cerca il tuo nome..." [active] [ref=e62]: test
      - generic: 🔍
    - generic [ref=e64]:
      - button "✕ Annulla" [ref=e65] [cursor=pointer]
      - button "✓ Conferma" [disabled] [ref=e66]
```